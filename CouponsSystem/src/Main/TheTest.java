...
//		}
		...
		try {
//			CouponSystem.login(name, password, clientType);
			adminFacade = (AdminFacade) couponSystem.login(name, password, clientType);
...
//		}
		...
		try {
//			CouponSystem.login(name, password, clientType);
			companyFacade = (CompanyFacade)couponSystem.login(name, password, clientType);
